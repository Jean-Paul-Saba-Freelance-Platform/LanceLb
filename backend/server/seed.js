...
async function seed() {
  ...
  const reviewsData = [
    { reviewerId: georges._id, revieweeId: rania._id,  projectId: project2._id, rating: 5, comment: "Rania is an exceptional React Native developer. Delivered clean, well-structured code on time and communicated proactively throughout. I'll definitely hire her again.", createdAt: daysAgo(2) },
    { reviewerId: fadi._id,    revieweeId: mayaH._id,  projectId: project3._id, rating: 5, comment: "Maya's translations are accurate, professional, and fast. She flagged an ambiguity in one contract that saved us from a potential misunderstanding. Highly recommended!", createdAt: daysAgo(3) },
    { reviewerId: fadi._id,    revieweeId: omar._id,   projectId: project4._id, rating: 4, comment: "Omar is organized, responsive, and handles tasks independently. Still building experience but already a reliable VA.", createdAt: daysAgo(5) },
    { reviewerId: saba._id,    revieweeId: jp._id,     projectId: project1._id, rating: 5, comment: "JP is an outstanding full-stack developer. The platform he's building is exactly what we envisioned. Clean code, fast delivery, always one step ahead.", createdAt: daysAgo(20) },
  ];
